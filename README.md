...
- Momentum, lateral tire grip, drifting, different surface grip, oriented car
  ...
  Tire grip limits cornering: entering too fast widens the turn and scrubs speed,
  especially on snow. Brake before tight corners; drifting trades grip and speed
  for rotation. Rivals plan braking around the same surface limits.
...
- Terrain-led streams: a meandering meadow creek feeds an irregular pond with
  ...
  vary in width and bank vegetation. Each crosses a dipped, curb-free ford; ponds
  are separated from the road. Water has a visible gravel bed, depth-dependent
...
- Six striped traffic cones surround a rough asphalt repair patch beside each
  circuit. Two outer bends have barriers of three stacks of three loose tires.
...
you need to steer toward them to collect them. A full tank cannot cover a complete
...
Each circuit combines the original two-lane road with a long four-lane section
of twice the width. Short entry and exit tapers connect the constant-width
